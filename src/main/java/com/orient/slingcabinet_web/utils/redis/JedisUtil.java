package com.orient.slingcabinet_web.utils.redis;
...
public class JedisUtil {
    ...
    /**
     * @func 设置redis键值-object-expiretime
     * @param key
     * @param value
     * @param expiretime
     * @return
    ...
    /**
     * @func 设置redis键值-Json-expiretime
     * @param key
     * @param value
     * @param expiretime
     * @return
